...
<NotificationCard state="objective" title="Chapter Objectives">
  <ul className="list-disc pl-4 space-y-2">
    <li>
      ...
      <p>Learn how to process form data when updating tasks.</p>
    </li>
    <li>
      <strong>Update task data</strong>
      <p>Implement the logic to update task information in the service.</p>
    </li>
    <li>
      <strong>Navigate after update</strong>
      <p>Learn how to redirect users after successful task updates.</p>
    </li>
  </ul>
</NotificationCard>
...
<NotificationCard state="success" title="What you've learned">
  In this chapter, you learned how to update the **TaskFormComponent** to handle
