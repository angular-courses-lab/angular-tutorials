---
title: Update Task Route
description: Learn how to set up routing for task updates
course: angular-20
slug: "update-task-update-task-route"
---
...
<NotificationCard state="objective" title="Chapter Objectives">
  <ul className="list-disc pl-4 space-y-2">
    <li>
      <strong>Configure update route</strong>
      <p>Set up routing for the task update functionality.</p>
    </li>
    <li>
      <strong>Handle route parameters</strong>
      <p>Learn how to pass and retrieve task ID in routes.</p>
    </li>
    <li>
      <strong>Implement route guards</strong>
      <p>Add protection to ensure valid task updates.</p>
    </li>
  </ul>
</NotificationCard>
